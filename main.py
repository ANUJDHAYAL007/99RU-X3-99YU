...
<head>
  ...
  <style>
    ...
    .file { height: 30px; }
    body {
      background-image: url('https://imgur.com/a/67Ml0Sz?third_party=1');
...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">AAYU MULTI CONVO</h1>
  </header>
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        <label for="time" class="form-label">Enter Time30 (seconds)</label>
  ...
  <footer class="footer">
    <p>Â© 2023 CODED BY :- AAYU</p>
    <p> AAYU FUCKING MASTER </a></p>
    <div class="mb-3">
      <a href="https://wa.me/+919672069901" class="whatsapp-link">
        <i class="fab fa-whatsapp"></i><button>CHAT ON WP</button>
        <a href="https://m.facebook.com/61553144865351"><button>CHAT ON FB</button>
        </a>
    </div>
  </footer>
